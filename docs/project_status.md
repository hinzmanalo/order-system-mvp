...
**Overall progress**: 0 / 16 features complete
...
|---|---------|--------|-------------|-------|
| 01 | [Backend Scaffolding](plans/01-backend-scaffolding.md) | Not Started | None | pom.xml, application config, main class |
